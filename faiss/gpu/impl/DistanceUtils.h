...
void runIncrementIndex(
        Tensor<T, 2, true>& indices,
        int k,
<<<<<<< HEAD:faiss/gpu/impl/DistanceUtils.cuh
        idx_t increment,
        cudaStream_t stream) {
...
>>>>>>> port_to_rocm/v1.7.3:faiss/gpu/impl/DistanceUtils.h
...
<<<<<<< HEAD:faiss/gpu/impl/DistanceUtils.cuh
    ...
    CUDA_TEST_ERROR();
=======
    hipLaunchKernelGGL(HIP_KERNEL_NAME(incrementIndex), grid, block, 0, stream, indices, k, increment);
>>>>>>> port_to_rocm/v1.7.3:faiss/gpu/impl/DistanceUtils.h
}
