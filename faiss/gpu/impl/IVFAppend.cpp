...
<<<<<<< HEAD:faiss/gpu/impl/IVFAppend.cu
        cudaStream_t stream) {
    auto numThreads =
...
>>>>>>> port_to_rocm/v1.7.3:faiss/gpu/impl/IVFAppend.cpp
...
void runIVFIndicesAppend(
    ...
    if (opt != INDICES_CPU && opt != INDICES_IVF) {
        ...
        hipLaunchKernelGGL(ivfIndicesAppend, blocks, threads, 0, stream, 
...
#define RUN_APPEND                                                  \
    do {                                                            \
        ...
        hipLaunchKernelGGL(ivfFlatAppend, grid, block, 0, stream,                   \
...
>>>>>>> port_to_rocm/v1.7.3:faiss/gpu/impl/IVFAppend.cpp
    ...
    hipLaunchKernelGGL(ivfpqAppend, threads, blocks, 0, stream, 
...
>>>>>>> port_to_rocm/v1.7.3:faiss/gpu/impl/IVFAppend.cpp
    ...
    hipLaunchKernelGGL(sqEncode, blocks, threads, 0, stream, vecs, encodedVecs, codec);
}
