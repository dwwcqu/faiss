...
<<<<<<< HEAD:faiss/gpu/impl/IVFBase.cuh
            Tensor<idx_t, 1, true>& indices,
...
>>>>>>> port_to_rocm/v1.7.3:faiss/gpu/impl/IVFBase.h
...
>>>>>>> port_to_rocm/v1.7.3:faiss/gpu/impl/IVFBase.h
   ...
   protected:
    ...
    /// Whether or not our index uses an interleaved by 64 layout:
    /// The default memory layout is [vector][PQ/SQ component]:
    /// (v0 d0) (v0 d1) ... (v0 dD-1) (v1 d0) (v1 d1) ...
    ///
    /// The interleaved by 64 memory layout is:
    /// [vector / 64][PQ/SQ component][vector % 64] with padding:
    /// (v0 d0) (v1 d0) ... (v63 d0) (v0 d1) (v1 d1) ... (v63 dD-1) (v64 d0)
    /// (v65 d0) ... so the list length is always a multiple of num quantizers *
    /// 64
