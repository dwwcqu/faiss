...
=======
            hipLaunchKernelGGL(HIP_KERNEL_NAME(l2NormColMajor<T, IndexType, true>), grid, block, 0, stream, input, output);
        } else {
            hipLaunchKernelGGL(HIP_KERNEL_NAME(l2NormColMajor<T, IndexType, false>), grid, block, 0, stream, input, output);
>>>>>>> port_to_rocm/v1.7.3:faiss/gpu/impl/L2Norm.cpp
        }
    }
